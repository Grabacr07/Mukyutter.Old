...
{
	partial class MukyutterGlowWindow
	{
		...
		public MukyutterGlowWindow(Window owner, GlowDirection direction)
		{
			InitializeComponent();
		...
		private IntPtr WndProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled)
		{
			...
			if (msg == (int)WM.LBUTTONDOWN)
			{
				...
				User32.PostMessage(this.ownerHandle, (uint)WM.NCLBUTTONDOWN, (IntPtr)this.getHitTestValue(pt), IntPtr.Zero);
			}
