...
namespace Codeplex.OAuth
{
    ...
    public class OAuthClient : OAuthBase
    {
        ...
        public IObservable<WebResponse> GetResponse()
        {
            ...
            {
                case MethodType.Get:
					return Observable.Defer(() => req.GetResponseAsync().ToObservable());
