...
namespace Grabacr07.Utilities.Reactive
{
	...
	public static class WebRequestExtensions
	{
		...
		{
			return Task.Factory.FromAsync<WebResponse>(request.BeginGetResponse, request.EndGetResponse, null).ToObservable();
		}

		public static IObservable<Stream> GetRequestStreamAsObservable(this WebRequest request)
		{
			return Task.Factory.FromAsync<Stream>(request.BeginGetRequestStream, request.EndGetRequestStream, null).ToObservable();
		}
	...
	public static class StreamExtensions
	{
		...
		{
			return Task.Factory.FromAsync((ac, o) => stream.BeginWrite(buffer, offset, count, ac, o), stream.EndWrite, null).ToObservable();
		}

		public static IObservable<int> ReadAsObservable(this Stream stream, byte[] buffer, int offset, int count)
		{
			return Task.Factory.FromAsync<int>((ac, o) => stream.BeginRead(buffer, offset, count, ac, o), stream.EndRead, null).ToObservable();
		}
