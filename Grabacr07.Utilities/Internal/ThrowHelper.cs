...
namespace Grabacr07.Utilities.Internal
{
	[Pure]
	internal static class ThrowHelper
	{
		...
		{
			throw new ArgumentException(string.Format("Arg_WrongType {0} {1}", key, targetType), "key");
		}

		internal static void ThrowWrongValueTypeArgumentException(object value, Type targetType)
		{
			throw new ArgumentException(string.Format("Arg_WrongType {0} {1}", value, targetType), "value");
		}
